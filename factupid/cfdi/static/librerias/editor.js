...
document.addEventListener("DOMContentLoaded", function () {
  ...
  editor = grapesjs.init({
    ...
    styleManager: {
      ...
      sectors: [
        {
          name: 'Estilos para el texto',
          open: false,
          buildProps: ['background-color', 'color',
            'font-family', 'font-size','font-weight',
            'font-style','text-align','cambios-globales'],
          properties: [
            {
...
fetch('get-modelos/').then(response => response.json())
  .then(data => {
  ...
  fetch('get-modelos/')
      ...
      .then(data => {
        let select = document.getElementById("selectPlantilla");
        ...
        if (data.length === 0) {
          ...
          // Si no hubo published, seleccionar la primera opción por defecto
          if (!publishedFound) {
  ...
  editor.BlockManager.add('FacturaBasica',{
    ...
    content: `
      ...
      <section>
        ...
        <div class="row">
          <div class="col-2">
            <img src="${imagen}" class="imagen-subida" alt="Logo" style="border: 1px solid black; width: 147px; height: 110px;"/>
          </div>
        ...
        <div class="row d-flex">
          <div class="col-2">
              <img src="https://via.placeholder.com/150" id="QR" alt="QR" class="img-fluid" style="Border: 1px solid black; width: 147px; height: 110px;"/>
          </div>
          <div class="col-7">
            <div class="row">
    ...
    <section>
      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="row">
            <div class="col-12 renglon"><p class="dato">[fCertificado_SAT]</p></div>
          </div>
          <div class="row">
            <div class="col-12 renglo encabezado-resaltado">Sello digital del SAT</div>
          </div>
          <div class="row">
            <div class="col-12 renglon"><p class="dato">[fSello_SAT]</p></div>
          </div>
          <div class="row">
            <div class="col-12 renglo encabezado-resaltado">Sello digital del contribuyente que lo expide</div> 
          </div>
          <div class="row">
            <div class="col-12 renglon"><p class="dato">[nSello_digital_contribuyente]</p></div>
          </div>    
          <div class="row">
            <div class="col-12 renglo encabezado-resaltado">Notas</div>
          </div>
          <div class="row">
            <div class="col-12 renglon"><p class="dato">[nNota]</p></div>
          </div>
          <div class="row">
        ...
        <div class="row d-flex justify-content-between">
          ...
          <div class="col-7">
            <table class="table table-sm table-bordered">
              <thead class="encabezado-tabla">
                <tr>
                  <th colspan="4">Total de las retenciones</th>
                </tr>
              </thead>
              <tbody>
                <tr>
        ...
        <div class="row d-flex justify-content-between">
          ...
          <div class="col-7">
            <table class="table table-sm table-bordered">
              <thead class="encabezado-tabla">
                <tr>
                  <th colspan="5">Total de las traslaciones</th>
                </tr>
              </thead>
              <tbody>
                <tr>
  ...
  //subri imagen i QR
  editor.BlockManager.add('qr', {
    label: 'QR',
    category: 'Imagen',
    attributes: { class: '' },
    content: `
      <img src="" id="QR" alt="QR" class="img-fluid" style="Border: 1px solid black; width: 147px; height: 110px;"/>
    `,
  });
  ...
  //################## Componentes CFDI_Traslado #####################
  //Datos Encabezado
  editor.BlockManager.add('TEncabezado', {
    label: 'Encabezado',
    category: 'Comp. Factura Traslado',
    attributes: { class: '' },
    content: `
    <style>
      .encabezado-resaltado{
    ...
    //Datos Encabezado
    editor.BlockManager.add('TEmisor', {
      label: 'Emisor',
      category: 'Comp. Factura Traslado',
      attributes: { class: '' },
      content: `
      ...
      //Datos Encabezado
  editor.BlockManager.add('TTraslado', {
    label: 'factura de Traslado',
    category: 'Comp. Factura Traslado',
    attributes: { class: '' },
    content: `
    <style>
    ...
    //Datos Encabezado
    editor.BlockManager.add('TReceptor', {
      label: 'Datos del receptor',
      category: 'Comp. Factura Traslado',
      attributes: { class: '' },
      content: `
      <style>
      ...
      //Datos Encabezado
  editor.BlockManager.add('TCFDI_relacionados', {
    label: 'CFDIs Relacionados',
    category: 'Comp. Factura Traslado',
    attributes: { class: '' },
    content: `
    ...
    //Datos Encabezado
    editor.BlockManager.add('TMetodoPago', {
      ...
      //Datos Encabezado
  editor.BlockManager.add('TConceptos', {
    label: 'Conceptos',
    category: 'Comp. Factura Traslado',
    attributes: { class: '' },
    content: `
    ...
    //Datos Encabezado
    editor.BlockManager.add('TTotal_traslaciones', {
      label: 'Total de las traslaciones',
      category: 'Comp. Factura Traslado',
      attributes: { class: '' },
      content: `
      <style>
      ...
      //Datos Encabezado
  editor.BlockManager.add('TDetalle carta porte', {
    label: 'Detalle carta porte',
    category: 'Comp. Factura Traslado',
    attributes: { class: '' },
    content: `
    <style>
    ...
    //Datos Encabezado
    editor.BlockManager.add('TDetalleTrasporte', {
      label: 'Detalle del transporte',
      category: 'Comp. Factura Traslado',
      attributes: { class: '' },
      content: `
      <style>
      ...
      //Datos Encabezado
  editor.BlockManager.add('TOrigen_destino', {
    ...
    //Datos Encabezado
    editor.BlockManager.add('TFigurasTrasporte', {
      ...
      //Datos Encabezado
  editor.BlockManager.add('TDetalleMercancia', {
    label: 'Detalle de la mercancia',
    category: 'Comp. Factura Traslado',
    attributes: { class: '' },
    content: `
    <style>
    ...
    //Datos Encabezado
    editor.BlockManager.add('TSellos', {
      label: 'Sellos',
      category: 'Comp. Factura Traslado',
      attributes: { class: '' },
      content: `
...
function procesarImagenes(html, clase, imagen) {
  return html.replace(/<img\b[^>]*>/gi, function(etiqueta) {
    const tieneClase = new RegExp(`class=["'][^"']*\\b${clase}\\b[^"']*["']`).test(etiqueta);
    const tieneIdQR = /id=["']QR["']/.test(etiqueta);
    const esImg = /^<img\b/i.test(etiqueta);

    if (esImg && tieneClase && tieneIdQR) {
      // Si es una imagen con clase específica e id="QR", dejamos src vacío
      return etiqueta.replace(/src=["'][^"']*["']/, 'src=""');
    } else if (esImg && /class=["'][^"']*\bimagen-subida\b[^"']*["']/.test(etiqueta)) {
      // Si es una imagen con clase imagen-subida, ponemos la URL del src
      if (etiqueta.includes('src=')) {
        return etiqueta.replace(/src=["'][^"']*["']/, `src="${imagen}"`);
      } else {
        return etiqueta.replace(/<img/, `<img src="${imagen}"`);
      }
    }
...
function handleModeloSelect() {
  ...
  editor.BlockManager.remove('imagen-subida');
  if (selectedValue === "0") {
  ...
  if (selectedValue === "nuevo") {
      ...
      const modalEl = document.getElementById("NuevaPlantilla");
      const modal = new bootstrap.Modal(modalEl);
      // Antes de mostrar el modal, carga los usuarios
      modalEl.addEventListener('show.bs.modal', function () {
        fetch('get-usuario/')
          .then(response => response.json())
          .then(data => {
            const select = document.getElementById('usuarioCFDI');
            select.innerHTML = '<option value="" disabled selected>Selecciona un usuario</option>';

            data.forEach(item => {
              const option = document.createElement('option');
              option.value = item.idUserCFDI;
              option.textContent = item.idUserCFDI__username;
              select.appendChild(option);
            });
          })
          .catch(error => {
      ...
      // Mostrar el modal manualmente cuando lo necesites
      modal.show();
      ...
      fetch(`get-plantilla/${selectedValue}`)
          ...
          .then(data => {
              if (data.exists) {
                  ...
                  if(data.img!=null){
                    editor.BlockManager.add('imagen-subida', {
                      label: 'Imagen subida',
                      category: {label: 'Imagen'},
                      attributes: { class: 'imagen-subida' },
                      select: true,
                      content: `
                        <img 
                          src="${data.img}"
                          class="imagen-subida" 
                          alt="Logo" 
                          style="border: 1px solid black; width: 147px; height: 110px;" 
                        />
                      `,
                    });
                  }
...
function GuardarPlantilla() {
  ...
  let usuario = document.getElementById("usuarioCFDI").value;
  if (!nombreModelo) {
    alert("Por favor, ingrese un nombre válido.");
    return;
  }
  if (!usuario) {
    alert("Por favor, seleccione un usuario CFDI.");
    return;
  }
  let formData = new FormData();
  formData.append('nombre', nombreModelo);
  formData.append('id_usuario', usuario);
  const csrftoken = document.querySelector('[name=csrfmiddlewaretoken]').value;
  const request = new Request('crear-modelo/', {
    method: 'POST',
      ...
      if (response.success) {
        ...
        alertContainer.innerHTML = `
          <div id="successAlert" class="alert alert-success alert-dismissible fade show" role="alert">
            El modelo <strong>${response.name}</strong> ha sido creado exitosamente.
  ...
  if (!modeloId || modeloId === "0") {
    ...
    switch (action) {
      case 'save':
          ...
          if (confirmacion) {
            html = editor.getHtml();
            html = procesarImagenes(html, "imagen-subida", imagen);
            html = procesarImagenes(html, "img-fluid", imagen);
            ...
            fetch(request).then((resp)=>resp.json()).then((response)=>{
              imagen = response.result.imagen_url;
...
function GuardarPlantillaComo(e) {
  e.preventDefault();
  ...
  html = procesarImagenes(html, "imagen-subida", imagen);
  html = procesarImagenes(html, "img-fluid", imagen);
  formData.append('id_modelo', modeloId);
  ...
  try {
    const request = new Request('saveas/', {
      method: 'POST',
      headers: { 'X-CSRFToken': csrftoken },
      mode: 'same-origin',
      body: formData
...
//Evento que servira para mandar el id de la plantilla
document.getElementById('btnSeleccionarPlantilla').addEventListener('click', function () {
  const select = document.getElementById('selectPlantilla');
  const selectedId = select.value;
  console.log(selectedId);
  let nombre = document.getElementById("selectPlantilla").options[document.getElementById("selectPlantilla").selectedIndex].text;
  if (!selectedId || selectedId == "No hay plantillas disponibles") {
    alert("Selecciona una plantilla antes de continuar.");
    return;
  }
  let confirmacion = confirm("¿Desea que la plantilla " + nombre + " sea la plantilla por defecto para imprimir CFDIs?");
  if (confirmacion) {
    const csrftoken = document.querySelector('[name=csrfmiddlewaretoken]').value;

    fetch('elegir_plantilla/', {
      method: 'POST',
      headers: {
      ...
      .then(data => {
        if (data.success) {
          ...
          alert(data.error || "Error al seleccionar la plantilla.");
        }
      })
      .catch(error => {
